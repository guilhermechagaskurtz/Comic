...
class AvisoCreateView(LoginRequiredMixin, StaffRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if (aviso.enviado):
            ...
            elif aviso.destinatario == 'ALUNO':
                destinatarios = Usuario.objects.filter(is_active=True, tipo='ALUNO')
            else:
                destinatarios = Usuario.objects.filter(is_active=True, tipo='PROFESSOR')
